...
class SOAResponseCreator extends AbstractCreator{

  private static final Logger log = LoggerFactory.getLogger(SOAResponseCreator.class)
  
  public SOAResponseCreator(Definitions definitions, def creator, MarkupBuilder builder) {
    super();
